...
public class post_ext_award extends AbstractProcedure {
    ...
    public Collection<Object> execute(String recog_cd, String recog_id, String frst_name, String last_name, Double amount, String post_desc, String prop_cd) throws SQLException, ProcedureException {
        /*
         * (]$[) $RCSfile$:$Revision: 6851 $ | CDATE=$Date: 2005-05-19 07:49:08 -0700 (Thu, 19 May 2005) $ ~
         * 
        ...
        Iterator<Object> it0 = create_ext_cust(recog_cd, recog_id, frst_name, null, last_name, null, null, null, null, null, null, null, null, null, null, null, null, entry_id).iterator();
        cust_id = (Integer) it0.next();
        acct_id = (Integer) it0.next();
        curr_frst = (String) it0.next();
        curr_mid = (String) it0.next();
        curr_last = (String) it0.next();
        acct_ind = (String) it0.next();
        cust_ind = (String) it0.next();
        addr_result = (String) it0.next();
