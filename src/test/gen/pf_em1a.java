...
public class pf_em1a extends AbstractProcedure {
    ...
    public String execute(Integer mbr_id, String promo_code, String stay_type, String prop, DateTime doa, Integer los, String rm_type, String srp_code, Double rm_revenue, String curr_code, Double rm_revenue_usd) throws SQLException, ProcedureException {
        /*
         * TITLE $RCSfile$ - Email promo EM1A for recepients of email  $Rev
         * ision: 1.2 $ 
         * 
         * (]$[) $RCSfile$:$Revision: 7872 $ | CDATE=$Date: 2000/10/16 13:49
         * :04 $ ~
         * 
        ...
        awarded = null;chain_id = null;chk_promo_cd = null;chk_offer_cd = null;
        //set debug file to '/tmp/pf_em1a.trace';

        // Check if the member has been awarded any of the two email promos 
        ...
        // Determine if the member belongs to email promo list EM1A
