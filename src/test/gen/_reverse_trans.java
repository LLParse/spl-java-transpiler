...
public class _reverse_trans extends AbstractProcedure {
    ...
    public Integer execute(Integer acct_trans_id, Integer entry_id, Integer std_desc_id, String notes) throws SQLException, ProcedureException {
        /*
         * $Id: _reverse_trans.sql 11531 2007-04-06 20:31:31Z kdamron $
         * 
        ...
        PreparedStatement pstmt1 = prepareStatement(
                  "select acct_trans.acct_id, acct_trans.trans_type, acct_trans.rev_acct_trans_id, acct_trans.rsub_acct_trans_id, acct_trans.trans_status, \"Reversed transaction. Original transaction (TransID \" || acct_trans.acct_trans_id || \") was a \" || decode(acct_trans.trans_type, \"S\", \"Stay\", \"R\", \"Redemption\", \"A\", \"Adjustment\", \"B\", \"Bonus\", \"E\", \"Expiration\", \"V\", \"Reversal\") || \" transaction posted on \" || acct_trans.init_dtime || \" for \" || ? || \".\""
                + " from acct_trans"
