...
public class _upd_acct_stmnt extends AbstractProcedure {
    ...
    public void execute(Integer acct_id, String trans_type, Double amount, String stay_type, String rev_indicator) throws SQLException, ProcedureException {
        /*
         * $RCSfile$ - Update an account statement record - $Revision: 6031 $
         * 
         * (]$[) $RCSfile$:$Revision: 6031 $ | CDATE=$Date: 2005-01-24 03:09:24 -0700 (Mon, 24 Jan 2005) $ ~
         * 
        ...
        update_life = null;
        stay_counter = 1;
        // default to increment stay counter
        ...
        current_stmnt_id = new get_stmnt_id().execute(new DateTime(), new get_recog_cd().execute(acct_id));
        ...
        pstmt1.close();
        rs1.close();
        if (last_stmnt_id.equals(current_stmnt_id)) {
            // get current values
        ...
        while (rs4.next()) {
            ...
            date_exp = new DateTime(rs4.getTimestamp(2).getTime());
            if (exp_rec.equals(1)) {
