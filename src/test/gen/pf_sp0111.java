...
public class pf_sp0111 extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, DateTime in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id) throws SQLException, ProcedureException {
        ...
        try {
            ...
            l_debug = (String) new settrace().execute("pf_sp0111");
            if (l_debug.equals("T")) {
            ...
            // stay meet basic requirements, now see if there are at least two stays during the

            // promo period, as bonus starts on second stay.
...
Iterator<Object> it0 = new find_linked_stays().execute(in_acct_id, start_date, stop_date).iterator();
            ...
            if (l_post_dtime != null) {
                pstmt8.setObject(6, l_post_dtime);
            }
            else {
            ...
            if (l_already_awarded.equals(1)) {
                PreparedStatement pstmt13 = prepareStatement("drop table recent_stay_trans_list_sp11");
        ...
        rs12.close();
        PreparedStatement pstmt15 = prepareStatement("drop table recent_stay_trans_list_sp11");
        ...
        error_data = e.getMessage();
        {
            if (l_table_created.equals("T")) {
                PreparedStatement pstmt16 = prepareStatement("drop table recent_stay_trans_list_sp11");
