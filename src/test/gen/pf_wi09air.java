...
public class pf_wi09air extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, DateTime in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id) throws SQLException, ProcedureException {
         ...
         *                         
         * $Id: pf_wi09air.sql 23874 2009-11-13 16:29:30Z rshepher $
         *    
        ...
        try {
            ...
            l_signup_date = new DateTime(rs1.getTimestamp(3).getTime());
            pstmt1.close();
            rs1.close();
            ...
            pstmt6.close();
            rs6.close();
            // So, this stay qualifies up to this point and we should only be dealing

            // with airline/non-GP accounts at this point. These need to go through the

            // linked stay wringer to see if a bonus is awarded.

            // Temp table to hold stays to consider

            // Get a list of linked air stays to consider
Iterator<Object> it0 = new find_linked_air_stays_by_promo().execute(in_promo_id, l_start_date, l_stop_date, in_acct_id).iterator();
            while (it0.hasNext()) {
            ...
            if (n_link.equals(in_stay_id)) {
                PreparedStatement pstmt10 = prepareStatement("drop table recent_stay_trans_list_wi09air");
            ...
            while (rs9.next()) {
                ...
                if (l_linked_trans_id != null) {
                    pstmt12.setInt(1, l_linked_trans_id);
                }
                else {
            ...
            pstmt11.close();
            rs9.close();
            PreparedStatement pstmt13 = prepareStatement("drop table recent_stay_trans_list_wi09air");
            ...
            {
                PreparedStatement pstmt14 = prepareStatement("drop table recent_stay_trans_list_wi09air");
