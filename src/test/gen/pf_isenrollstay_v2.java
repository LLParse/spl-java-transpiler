...
public class pf_isenrollstay_v2 extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, DateTime in_doa, DateTime in_dod) throws SQLException, ProcedureException {
        /*
         ...
         *    
         * $Id: pf_isenrollstay_v2.sql 36968 2011-03-01 22:39:33Z mgiroux $
         * 
        ...
        try {
            ...
            l_debug = (String) new settrace().execute("pf_isenrollstay_v2");
            if (l_debug.equals("T")) {
            ...
            if ((l_signup_date.isAfter(in_doa) || l_signup_date.isEqual(in_doa)) && (l_signup_date.isBefore(in_dod) || l_signup_date.isEqual(in_dod)) && l_appl_source != null && l_appl_source.equals("H")) {
                l_answer = "T";
            }
            return l_answer;
        }
