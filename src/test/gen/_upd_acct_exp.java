...
public class _upd_acct_exp extends AbstractProcedure {
    ...
    public void execute(Integer acct_id_in, Double amount_in, Integer acct_trans_id_in, DateTime exp_date_in) throws SQLException, ProcedureException {
        /*
         * $RCSfile$ - Update the amount of amount expiring from an account - $Revision: 10915 $
         * 
         *         (]$[) $RCSfile$:$Revision: 10915 $ | CDATE=$Date: 2007-01-04 14:46:57 -0700 (Thu, 04 Jan 2007) $ ~
         * 
        ...
        Iterator<Object> it0 = new get_trans_aging_type().execute(acct_trans_id_in, amount_in).iterator();
        l_aging_type = (String) it0.next();
        l_orig_trans_id = (Integer) it0.next();
        ...
        if (amount_in > 0.0) {
            ...
            if (l_aging_type.equals("redemption")) {
                ...
                while (rs3.next()) {
                    ...
                    if (l_tmp_amount < amount_required.intValue()) {
                        amount_required = amount_required - l_tmp_amount.doubleValue();
            ...
            while (rs4.next()) {
                t_exp_date = new DateTime(rs4.getTimestamp(1).getTime());
