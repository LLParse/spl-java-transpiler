...
public class find_linked_cust_stays extends AbstractProcedure {
    ...
    public Collection<Object> execute(Integer cust_id_in, DateTime begin_date_in, DateTime end_date_in) throws SQLException, ProcedureException {
        /*
         * find_linked_cust_stays.sql - iterates through stays and links concurrent and consequtive stays
         * for a customer.          
         * $Id: find_linked_cust_stays.sql 11533 2007-04-06 20:42:05Z fbloomfi $
         *    
