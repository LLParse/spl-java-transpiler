...
public class pf_vanilla_stay_twice extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, DateTime in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id) throws SQLException, ProcedureException {
         ...
         *    
         * $Id: pf_vanilla_stay_twice.sql 52644 2012-06-25 23:47:41Z rick_shepherd $
         *    
        ...
        try {
            ...
            l_debug = (String) new settrace().execute("pf_vanilla_stay_twice");
            if (l_debug.equals("T")) {
            ...
            if (l_economy.equals("T") && l_economy_eligible.equals("F")) {
                Iterator<Object> it0 = new pf_find_consecutive_economy().execute(in_acct_id, in_stay_id, in_doa, l_link, l_offer_cd).iterator();;
            ...
            if (l_eligible.equals("T")) {
                ...
                l_answer = (String) new pf_vanilla_stay_twice_awardbonus().execute(in_acct_id, in_promo_id, in_stay_type, in_prop_id, in_doa, in_los, in_rm_type, in_srp_code, in_rm_revenue, in_fb_revenue, in_other_revenue, in_curr_code, in_res_source, in_stay_id, l_link, l_offer_dtime, l_offer_cd);
            }
