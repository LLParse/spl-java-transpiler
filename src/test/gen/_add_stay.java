...
public class _add_stay extends AbstractProcedure {
    ...
    public Integer execute(Integer cust_id, Integer acct_trans_id, String cxl_flag, Integer conf_nbr, Integer prop_id, DateTime doa, Integer los, String rm_type, Integer rooms, String srp_code, Double rm_revenue_pc, Double rm_revenue_cc, Double fb_revenue_pc, Double fb_revenue_cc, Double other_revenue_pc, Double other_revenue_cc, String prop_curr_code, String cust_cur_code, String payment_meth, String invoice_prop, String denial, DateTime folio_xmit_date, String stay_type, String data_source, String res_source, DateTime tai_date) throws SQLException, ProcedureException {
        /*
