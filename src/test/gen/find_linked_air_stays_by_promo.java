...
public class find_linked_air_stays_by_promo extends AbstractProcedure {
    ...
    public Collection<Object> execute(Integer promo_id_in, DateTime begin_date_in, DateTime end_date_in, Integer acct_id_in) throws SQLException, ProcedureException {
        /*
         * $Id: find_linked_air_stays_by_promo.sql 12563 2007-08-01 19:13:19Z eelliot $
         * 
        ...
        //trace on;
Iterator<Object> it0 = new find_linked_air_stays().execute(acct_id_in, begin_date_in, end_date_in).iterator();
        while (it0.hasNext()) {
