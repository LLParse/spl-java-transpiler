...
public class pf_wi1211_awardbonus extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, DateTime in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id, DateTime in_start_date, DateTime in_stop_date) throws SQLException, ProcedureException {
         ...
         *                                                            
         * $Id: pf_wi1211_awardbonus.sql 46610 2011-12-13 17:27:20Z rshepher $
         *    
        ...
        try {
            ...
            l_debug = (String) new settrace().execute("pf_wi1211_awardbonus");
            if (l_debug.equals("T")) {
...
Iterator<Object> it0 = new find_linked_stays_by_promo().execute(in_promo_id, l_start_date, l_stop_date, in_acct_id).iterator();
            while (it0.hasNext()) {
                ...
                rs13.next();
                l_post_dtime = new DateTime(rs13.getTimestamp(1).getTime());
                pstmt13.close();
                rs13.close();
            ...
            rs16.next();
            l_post_dtime = new DateTime(rs16.getTimestamp(1).getTime());
            pstmt17.close();
            rs16.close();
            ...
            while (rs17.next()) {
                ...
                l_doa = new DateTime(rs17.getTimestamp(3).getTime());
            ...
            pstmt19.close();
            rs17.close();
            PreparedStatement pstmt21 = prepareStatement("drop table recent_stay_trans_list_wi1211");
            ...
            error_data = e.getMessage();
            {
                ...
                pstmt22.close();
                PreparedStatement pstmt23 = prepareStatement("drop table recent_stay_trans_list_wi1211");
