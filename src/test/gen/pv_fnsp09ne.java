...
public class pv_fnsp09ne extends AbstractProcedure {
    ...
    public Double execute(Integer acct_id, Integer cust_id, Integer promo_id, Integer criteria, Double value, Double stay_rev, String chain_cd, Integer los, Integer stay_id) throws SQLException, ProcedureException {
        /*
         * $Id: pv_fnsp09ne.sql 20931 2009-02-26 22:48:48Z rshepher $
         * 
         *   Description: 
         * 
        ...
        rs2.next();
        signup_date = new DateTime(rs2.getTimestamp(1).getTime());
        pstmt2.close();
        rs2.close();
...
Iterator<Object> it0 = new find_linked_stays_by_promo().execute(promo_id, promo_start_date, promo_stop_date, acct_id).iterator();
        ...
        while (rs3.next()) {
            ...
            while (rs4.next()) {
                ...
                l_doa = new DateTime(rs5.getTimestamp(2).getTime());
                pstmt6.close();
                rs5.close();
                if (last_res_source != null && (last_res_source.equals("C") || last_res_source.equals("N")) && found_trans.equals("F")) {
                    // found trans yet?
