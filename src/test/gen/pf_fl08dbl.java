...
public class pf_fl08dbl extends AbstractProcedure {
    ...
    public String execute(Integer acct_id, Integer promo_id, String stay_type, Integer prop_id, DateTime doa, Integer los, String rm_type, String srp_code, Double rm_revenue, Double fb_revenue, Double other_revenue, String curr_code, String res_source, Integer stay_id) throws SQLException, ProcedureException {
        /*
         * pf_fl08dbl.sql - Checks if stay qualifies for Fall 2008 general douple point promotion. 
         *                  It is called by the wrapper functions pf_fl08ed and pf_fl08numd and
         *                  does this:
         *                  DOA falls within promotion period.
         *                  After first stay.
         *                  NOT booked via internet or 800-4CHOICE
        ...
        start_date = null;
        stop_date = null;
        //set debug file to '/tmp/pf_fl08dbl.trace';
        ...
        // Check the res_source to see if it's NOT set to 'N'-internet or 'C'-800-4CHOICE.

        if (res_source == null) {
            return "F";
        }
        if (res_source.equals("N") || res_source.equals("C")) {
            return "F";
        }
    ...
    ResultSet rs3 = executeQuery(pstmt2);
    rs3.next();
    qual_stay_amt = rs3.getDouble(1);
    rs3.close();
    ...
    ResultSet rs4 = executeQuery(pstmt3);
    rs4.next();
    bonus_cnt = rs4.getInt(1);
    pstmt3.close();
    rs4.close();
    if (bonus_cnt > 0) {
        return "F";
