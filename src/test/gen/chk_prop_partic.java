...
public class chk_prop_partic extends AbstractProcedure {
    ...
    public Integer execute(Integer acct_id, Integer prop_id, DateTime doa, Integer los, String rm_type, String srp_code, Double rm_revenue, Double fb_revenue, Double other_revenue, Integer p_promo_id, String recog_cd, String prop_curr_cd, Integer m_appl_group, String p_chain_id, String p_mkt_area, String p_country, String p_prop_type, String p_ioc_region, String p_prop_class, Integer stay_id, String stay_type) throws SQLException, ProcedureException {
        ...
        while (rs1.next()) {
            ...
            start_date = new DateTime(rs1.getTimestamp(11).getTime());
            stop_date = new DateTime(rs1.getTimestamp(12).getTime());
            ...
            if (chain_group_id != null) {
                ...
                chk_start = new DateTime(rs3.getTimestamp(2).getTime());
                chk_stop = new DateTime(rs3.getTimestamp(3).getTime());
                pstmt3.close();
                rs3.close();
                if (chk_group_id != null) {
                    ...
                    if (doa != null) {
                        if (doa.isBefore(chk_start) || doa.isAfter(chk_stop)) {
                            continue;
                        }
                    }
                }
            ...
            if (l_region_id != null) {
                if (p_country != null) {
                    ...
                    chk_start = new DateTime(rs4.getTimestamp(2).getTime());
                    chk_stop = new DateTime(rs4.getTimestamp(3).getTime());
                    pstmt4.close();
                    rs4.close();
