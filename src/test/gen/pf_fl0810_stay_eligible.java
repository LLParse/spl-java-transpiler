...
public class pf_fl0810_stay_eligible extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_stay_id, Integer in_promo_id, DateTime in_signup_date, String in_recog_cd, Integer in_flag) throws SQLException, ProcedureException {
        /*
         * $Id: pf_fl0810_stay_eligible.sql 30645 2010-08-06 15:15:18Z rshepher $
         * 
         *   Description: 
         * 
        ...
        try {
            ...
            l_doa = new DateTime(rs2.getTimestamp(2).getTime());
            pstmt2.close();
            rs2.close();
            ...
            if (l_eligible.equals("F") && l_doa.isEqual(in_signup_date)) {
                l_eligible = "T";
            }
