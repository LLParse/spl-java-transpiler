...
public class pf_sp0312reg extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, DateTime in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id) throws SQLException, ProcedureException {
         ...
         *    
         * $Id: pf_sp0312reg.sql 52307 2012-06-18 23:30:58Z rick_shepherd $
         *    
        ...
        try {
            ...
            l_debug = (String) new settrace().execute("pf_sp0312reg");
            if (l_debug.equals("T")) {
            ...
            if (l_economy.equals("T") && l_economy_eligible.equals("F")) {
                Iterator<Object> it0 = new pf_find_consecutive_economy().execute(in_acct_id, in_stay_id, in_doa, l_link, "SP0312O").iterator();;
            ...
            if (l_eligible.equals("T")) {
                ...
                l_answer = (String) new pf_sp0312_awardbonus().execute(in_acct_id, in_promo_id, in_stay_type, in_prop_id, in_doa, in_los, in_rm_type, in_srp_code, in_rm_revenue, in_fb_revenue, in_other_revenue, in_curr_code, in_res_source, in_stay_id, l_link, l_offer_dtime);
            }
