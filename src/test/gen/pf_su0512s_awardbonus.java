...
public class pf_su0512s_awardbonus extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, DateTime in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id, Integer in_link, DateTime in_offer_dtime) throws SQLException, ProcedureException {
         ...
         *                           
         *    
         *        $Id: pf_su0512s_awardbonus.sql 50156 2012-04-23 22:01:01Z rick_shepherd $
         *    
        ...
        try {
            ...
            // Temp table passed to pv_su0512s. It will hold the point values
            ...
            while (rs5.next()) {
                ...
                if (l_economy.equals("T") && l_economy_eligible.equals("F")) {
                    Iterator<Object> it0 = new pf_find_consecutive_economy().execute(in_acct_id, l_stay_id, l_doa, l_linked_id, "SU0512O").iterator();;
            ...
            if (l_total_qualified < 2) {
                ...
                pstmt16.close();
                PreparedStatement pstmt17 = prepareStatement("drop table qualified_stays_pv_su0512");
            ...
            error_data = e.getMessage();
            {
                ...
                pstmt18.close();
                PreparedStatement pstmt19 = prepareStatement("drop table qualified_stays_pv_su0512");
