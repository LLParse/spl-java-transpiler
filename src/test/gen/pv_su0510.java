...
public class pv_su0510 extends AbstractProcedure {
    ...
    public Double execute(Integer in_acct_id, Integer in_cust_id, Integer in_promo_id, Integer in_criteria, Double in_value, Double in_stay_rev, String in_chain_cd, Integer in_los, Integer in_stay_id) throws SQLException, ProcedureException {
        /*
         * $Id: pv_su0510.sql 27972 2010-04-16 23:29:13Z rshepher $
         * 
         *   Description: 
         * 
         *   Compute the amount of points to award for Summer 2010 promo, 
        ...
        try {
            ...
            l_residual = 0.0;
            l_row_count = 0;
            //set debug file to '/tmp/pv_su0510.trace';

            //trace on;

            PreparedStatement pstmt1 = prepareStatement(
                      "select count(*), sum(amount)"
                    + " from qualified_stays_pv_su10");
            ...
            if (!l_row_count.equals(2) || l_sum_points == null) {
                throw new ProcedureException(-746, 0, "pv_su0510: qualified_stays_pv_su10 table count error");
            }
            ...
            PreparedStatement pstmt2 = prepareStatement("drop table qualified_stays_pv_su10");
            ...
            {
                PreparedStatement pstmt3 = prepareStatement("drop table qualified_stays_pv_su10");
