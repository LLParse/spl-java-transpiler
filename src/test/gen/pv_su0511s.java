...
public class pv_su0511s extends AbstractProcedure {
    ...
    public Double execute(Integer in_acct_id, Integer in_cust_id, Integer in_promo_id, Integer in_criteria, Double in_value, Double in_stay_rev, String in_chain_cd, Integer in_los, Integer in_stay_id) throws SQLException, ProcedureException {
        /*
         * $Id: pv_su0511s.sql 37519 2011-03-22 03:44:49Z croberts $
         * 
         *   Description: 
         * 
        ...
        try {
            ...
            l_debug = (String) new settrace().execute("pv_su0511s");
            if (l_debug.equals("T")) {
            ...
            PreparedStatement pstmt2 = prepareStatement("drop table qualified_stays_pv_su0511");
            ...
            {
                PreparedStatement pstmt3 = prepareStatement("drop table qualified_stays_pv_su0511");
