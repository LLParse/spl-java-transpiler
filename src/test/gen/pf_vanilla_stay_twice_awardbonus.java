...
public class pf_vanilla_stay_twice_awardbonus extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, DateTime in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id, Integer in_link, DateTime in_offer_dtime, String in_offer_cd) throws SQLException, ProcedureException {
         ...
         *                           
         *     $Id: pf_vanilla_stay_twice_awardbonus.sql 52644 2012-06-25 23:47:41Z rick_shepherd $
         *    
        ...
        try {
            ...
            // Temp table passed to pv_vanilla_stay_twice. It will hold the point values
            ...
            while (rs5.next()) {
                ...
                if (l_economy.equals("T") && l_economy_eligible.equals("F")) {
                    Iterator<Object> it0 = new pf_find_consecutive_economy().execute(in_acct_id, l_stay_id, l_doa, l_linked_id, in_offer_cd).iterator();;
            ...
            if (l_eligible.equals("T")) {
                ...
                while (rs8.next()) {
                    ...
                    if (l_current_doa != null && l_doa2.isEqual(l_current_doa) && l_bonus_contrib.equals("Y")) {
            ...
            if (l_total_qualified < 2) {
                ...
                pstmt16.close();
                PreparedStatement pstmt17 = prepareStatement("drop table qualified_stays_vanilla_stay_twice");
            ...
            error_data = e.getMessage();
            {
                ...
                pstmt18.close();
                PreparedStatement pstmt19 = prepareStatement("drop table qualified_stays_vanilla_stay_twice");
