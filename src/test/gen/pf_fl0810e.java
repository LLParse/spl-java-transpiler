...
public class pf_fl0810e extends AbstractProcedure {
    ...
    public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, DateTime in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id) throws SQLException, ProcedureException {
         ...
         *           
         * $Id: pf_fl0810e.sql 31665 2010-09-14 17:28:45Z mgiroux $
         *    
        ...
        if (l_eligible.equals("F")) {
            ...
            pstmt4.close();
            rs4.close();
            if ( || l_recog_cd.equals("MC") || l_recog_cd.equals("CE")) {
                l_eligible = "T";
            }
        }
        ...
        l_answer = (String) new pf_fl0810e_awardbonus().execute(in_acct_id, in_promo_id, in_stay_type, in_prop_id, in_doa, in_los, in_rm_type, in_srp_code, in_rm_revenue, in_fb_revenue, in_other_revenue, in_curr_code, in_res_source, in_stay_id);
        return l_answer;
    }
