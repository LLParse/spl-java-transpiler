...
public class pf_vanilla_stay_twice_awardbonus_noreg extends AbstractProcedure {
	...
	public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, Timestamp in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id, Integer in_link) throws SQLException, ProcedureException {		
		...
		/*
		 * pf_vanilla_stay_twice_awardbonus_noreg.sql - 
		 * 
		 ...
		 *                           
		 *    
		 *        $Id: pf_vanilla_stay_twice_awardbonus_noreg.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 *    
		...
		try {			
			...
			while (rs5.next()) {
				...
				if (l_economy.equals("T") && l_economy_eligible.equals("F")) {					
					...
					Iterator<Object> it0 = pf_find_consecutive_economy(in_acct_id, l_stay_id, l_doa, l_linked_id, "SP0312O").iterator();
