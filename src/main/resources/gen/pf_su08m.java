...
public class pf_su08m extends AbstractProcedure {
	...
	public String execute(Integer acct_id, Integer promo_id, String stay_type, Integer prop_id, Timestamp doa, Integer los, String rm_type, String srp_code, Double rm_revenue, Double fb_revenue, Double other_revenue, String curr_code, String res_source, Integer stay_id) throws SQLException, ProcedureException {		
		...
		/*
		 * pf_su08m.sql -    Check if stay is eligible for the
		 *                      'Stay 3 Times, Earn Gas Card'
		 *                      Summer 2008 stay 3 times promotion. 
		 ...
		 *    
		 *           
		 * $Id: pf_su08m.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 *    
		...
		//set debug file to '/tmp/pf_su08m.trace';
		//trace on;
		...
		PreparedStatement pstmt9 = prepareStatement(
				...
				+ " from recent_stay_trans_list l, stay s"
				+ " where l.doa >= ?"
				+ " and l.doa <= ?"
