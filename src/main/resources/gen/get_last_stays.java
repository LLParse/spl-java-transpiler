...
public class get_last_stays extends AbstractProcedure {
	...
	public Collection<Object> execute(String recog_cd, String recog_id, Integer max_stays) throws SQLException, ProcedureException {		//bonus name
		...
		try {			
			...
			PreparedStatement pstmt1 = prepareStatement(
					...
					+ " and t.final_dtime > current - 2year"
