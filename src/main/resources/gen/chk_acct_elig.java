...
public class chk_acct_elig extends AbstractProcedure {
	...
	public Integer execute(Integer acct_id, Integer prop_id, Timestamp doa, Integer los, String rm_type, String srp_code, Double rm_revenue, Double fb_revenue, Double other_revenue, Integer promo_id, String recog_cd, String curr_cd, Integer appl_group, Integer elite_level_id, String res_source, Integer filter_data) throws SQLException, ProcedureException {		
