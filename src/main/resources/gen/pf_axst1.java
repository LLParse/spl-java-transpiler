...
public class pf_axst1 extends AbstractProcedure {
	...
	public String execute(Integer mbr_id, String promo_code, String stay_type, String prop, Timestamp doa, Integer los, String rm_type, String srp_code, Double rm_revenue, String curr_code, Double rm_revenue_usd) throws SQLException, ProcedureException {		
		...
		//update statistics for procedure pf_axst1;
		
		//set debug file to '/tmp/pf_axst1.trace';
		
		//
		// Determine whether or not the member has been awarded the AXST1 promotion. 
		//
		...
		//
		// Determine whether or not the member has been offered the AXST1 promotion.
		//
