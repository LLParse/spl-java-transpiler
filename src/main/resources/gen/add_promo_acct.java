...
public class add_promo_acct extends AbstractProcedure {
	...
	public Integer execute(Integer promo_id, String elig_type, String recog_cd, String appl_group_cd, String offer_cd, String location, String payment_meth, String filter_name, String elite_level_name, String user_name, Timestamp start_date_in, Timestamp stop_date_in) throws SQLException, ProcedureException {		
		...
		if (payment_meth != null) {			
			...
			// validate the dates
			if (start_date_in < new Timestamp(System.currentTimeMillis()) - 5day) {				
				throw new ProcedureException(-746, 0, "start date is out of range");
			}			
			
			if (stop_date_in < new Timestamp(System.currentTimeMillis())) {				
