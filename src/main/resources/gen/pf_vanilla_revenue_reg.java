...
public class pf_vanilla_revenue_reg extends AbstractProcedure {
	...
	public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, Timestamp in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id) throws SQLException, ProcedureException {		
		 ...
		 *    
		 *        $Id: pf_vanilla_revenue_reg.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 *    
		...
		try {			
			...
			l_debug = new settrace().execute("pf_vanilla_revenue_reg");			
			if (l_debug.equals("T")) {				
			...
			Iterator<Object> it0 = pf_revenue_booking(in_acct_id, in_doa, in_los, in_res_source, in_stay_id, l_promo_cd).iterator();
			l_answer = (String) it0.next();
			l_check_consecutive = (String) it0.next();;			
				...
				while (rs4.next()) {
					...
					if (l_srp_code != null && l_srp_code.equals("SRD")) {						
						...
						while (rs5.next()) {
							...
							if (l_points > 0 && l_doa2 >= l_offer_dtime) {								
