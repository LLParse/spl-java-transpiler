...
public class pv_fnfl08m extends AbstractProcedure {
	...
	public Double execute(Integer acct_id, Integer cust_id, Integer promo_id, Integer criteria, Double value, Double stay_rev, String chain_cd, Integer los, Integer stay_id) throws SQLException, ProcedureException {		
		...
		/*
		 * $Id: pv_fnfl08m.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 * 
		 *   Description: 
		 * 
		 *   Compute the amount of points to award a gas card, up to 14000. 
		 *   The sum of the last 2 stay base points + base points of this stay
		 *   are taken into account.
		 *   Note: Minimum points awarded is 10,000 max 14,000.
		 * 
		...
		//set debug file to '/tmp/pv_fnfl08m.trace';
		//trace on;
		...
		residual = mod(this_stay_value, 14000);		
