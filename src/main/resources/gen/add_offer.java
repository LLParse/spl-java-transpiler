...
public class add_offer extends AbstractProcedure {
	...
	public Integer execute(String offer_cd, String offer_desc, Timestamp start_date, Timestamp stop_date, Integer campaign_id, String contact_method, String recog_cd, String user_name) throws SQLException, ProcedureException {		
