...
public class pf_su0511s_awardbonus extends AbstractProcedure {
	...
	public String execute(Integer in_acct_id, Integer in_promo_id, String in_stay_type, Integer in_prop_id, Timestamp in_doa, Integer in_los, String in_rm_type, String in_srp_code, Double in_rm_revenue, Double in_fb_revenue, Double in_other_revenue, String in_curr_code, String in_res_source, Integer in_stay_id, String in_platinum, String in_diamond, Integer in_max_awards) throws SQLException, ProcedureException {		
		 ...
		 *                           
		 *    
		 * $Id: pf_su0511s_awardbonus.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 *    
		...
		try {			
			...
			l_debug = new settrace().execute("pf_su0511s_awardbonus");			
			if (l_debug.equals("T")) {				
			...
			if (l_debug.equals("T")) {				
				...
				while (rs9.next()) {
					...
					l_dbg_doa = rs9.getTimestamp(3);
					l_dbg_dod = rs9.getTimestamp(4);
					l_dbg_linked_id = rs9.getInt(5);
					l_dbg_acct_trans_id = rs9.getInt(6);
					l_dbg_ord = rs9.getInt(7);
					l_dbg_post_dtime = rs9.getTimestamp(8);
				}
				pstmt11.close();
			}			
			...
			while (rs14.next()) {
				...
				if (l_bonus_contrib != null) {
					pstmt19.setString(4, l_bonus_contrib);
				}
				else {
					pstmt19.setNull(4, Types.JAVA_OBJECT);
				}
			...
			while (rs15.next()) {
				...
				Iterator<Object> it0 = pf_su0511s_stay_eligible(in_acct_id, l_stay_id, in_promo_id, l_signup_date, l_recog_cd).iterator();
				...
				if (l_is_econo.equals("T")) {					
					...
					if (l_econo_eligible.equals("F")) {						
						...
						while (rs18.next()) {
							...
							if (l_doa.equals(l_doa2)) {								
								...
								Iterator<Object> it0 = pf_su0511s_stay_eligible(in_acct_id, l_stay_id2, in_promo_id, l_signup_date, l_recog_cd).iterator();
								l_is_elig = (String) it0.next();
								l_is_econo = (String) it0.next();
								l_econo_eligible = (String) it0.next();;								
					...
					if (l_made_eligible.equals("T")) {						
						...
						while (rs19.next()) {
							...
							if (l_bonus_contrib != null) {
								pstmt28.setString(4, l_bonus_contrib);
							}
							else {
								pstmt28.setNull(4, Types.JAVA_OBJECT);
							}
					...
					while (rs20.next()) {
						...
						if (l_current_doa != null && l_doa2.equals(l_current_doa)) {							
							...
							if (l_bonus_contrib != null) {
								pstmt31.setString(4, l_bonus_contrib);
							}
							else {
								pstmt31.setNull(4, Types.JAVA_OBJECT);
							}
				...
				// midscale eligible
					...
					if (l_is_elig.equals("T")) {						
						...
						while (rs22.next()) {
							...
							if (l_bonus_contrib != null) {
								pstmt35.setString(4, l_bonus_contrib);
							}
							else {
								pstmt35.setNull(4, Types.JAVA_OBJECT);
							}
