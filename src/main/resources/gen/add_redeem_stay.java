...
public class add_redeem_stay extends AbstractProcedure {
	...
	public Collection<Object> execute(String prop, Timestamp doa, Integer los, Integer gnr_num, String cxl_ind, String rm_type, String srp_code, Double rm_revenue, String curr_cd, String recog_cd, String recog_id, Double amount, String res_source) throws SQLException, ProcedureException {		
		...
		if (redeem_amount < 0) {			
			...
			PreparedStatement pstmt2 = prepareStatement(
					  "select ("sum(acct_exp_temp.amount)
					+ ") * -1"
					+ " from acct_exp_temp"
			...
			if (acct_balance < abs(redeem_amount)) {				
				balance_diff = (acct_balance + redeem_amount) * -1;				
		...
		new process_stay().execute(acct_id, stay_id, null, amount, null);		
