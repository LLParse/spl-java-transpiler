...
public class _reject_trans extends AbstractProcedure {
	...
	public void execute(Integer acct_trans_id, Integer par_result_msg_id, Timestamp rej_dtime) throws SQLException, ProcedureException {		
		/*
		 * $RCSfile$ - Set an acct_trans record to reject status - $Revision: 99 $
		 * 
