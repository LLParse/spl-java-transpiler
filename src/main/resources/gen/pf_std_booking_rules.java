...
public class pf_std_booking_rules extends AbstractProcedure {
	...
	public String execute(Integer in_acct_id, Timestamp in_doa, Integer in_los, String in_res_source) throws SQLException, ProcedureException {		
		
		/*
		 * $Id: pf_std_booking_rules.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 * 
		 *   Description: 
		 * 
