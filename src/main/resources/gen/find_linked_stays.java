...
public class find_linked_stays extends AbstractProcedure {

	public Collection<Object> execute(Integer acct_id_in, Timestamp begin_date_in, Timestamp end_date_in) throws SQLException, ProcedureException {		
		
		/*
		 * find_linked_stays.sql - iterates through stays and links concurrent and consequtive stays
		 *           
		 * $Id: find_linked_stays.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 *    
		...
		//    set debug file to '/tmp/find_linked_stay_id.trace';
		//    trace on;
