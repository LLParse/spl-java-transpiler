...
public class find_linked_stays_by_promo extends AbstractProcedure {
	...
	public Collection<Object> execute(Integer promo_id_in, Timestamp begin_date_in, Timestamp end_date_in, Integer acct_id_in) throws SQLException, ProcedureException {		
		...
		/*
		 * $Id: find_linked_stays_by_promo.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 * 
		...
		Iterator<Object> it0 = find_linked_stays(acct_id_in, begin_date_in, end_date_in).iterator();
