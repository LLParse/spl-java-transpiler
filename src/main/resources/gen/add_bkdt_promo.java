...
public class add_bkdt_promo extends AbstractProcedure {
	...
	public Integer execute(String promo_cd, String promo_name, String promo_desc, String trigger, Timestamp start_date, Timestamp stop_date, String rule, Integer max_uses, String use_rm_rev, String use_fb_rev, String use_other_rev, Integer campaign_id, Integer billing_cat_id, String recog_cd, String user_name) throws SQLException, ProcedureException {		
