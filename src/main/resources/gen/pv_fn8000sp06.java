...
public class pv_fn8000sp06 extends AbstractProcedure {
	...
	public Double execute(Integer acct_id, Integer cust_id, Integer promo_id, Integer criteria, Double value, Double stay_rev, String chain_cd, Integer los, Integer stay_id) throws SQLException, ProcedureException {		
		...
		/*
		 * $Id: pv_fn8000sp06.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 * 
		 *   Description: 
		 * 
		...
		//set debug file to '/tmp/pv_fn8000sp06.trace';
		//trace on;
		...
		PreparedStatement pstmt2 = prepareStatement(
				...
				+ " and p.country in (\"US\", \"CN\", \"MX\", \"BS\", \"PR\", \"CI\", \"TC\", \"DO\")"
