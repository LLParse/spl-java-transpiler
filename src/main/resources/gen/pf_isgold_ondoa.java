...
public class pf_isgold_ondoa extends AbstractProcedure {

	public String execute(Integer in_acct_id, Timestamp in_doa) throws SQLException, ProcedureException {		
		
		
		/*
		 * pf_isgold_ondoa.sql - Determine if the elite status on the DOA of the stay was Gold.
		 * 
		 * $Id: pf_isgold_ondoa.sql 99 2012-12-19 21:14:54Z michael_giroux $
		 * 
		...
		//set debug file to '/tmp/pf_isgold_ondoa.trace';
		//trace on;
